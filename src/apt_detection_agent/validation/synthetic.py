...
This module deliberately never imports ``apt_detection_agent.evaluator``. Hidden
...
from apt_detection_agent.controller import Controller, ControllerConfig, TrajectoryLogger
