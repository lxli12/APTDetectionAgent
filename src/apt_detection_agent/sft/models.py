...
class DetectorCapabilitySnapshot(StrictModel):
    """Offline copy of the public capability view; no tool implementation import."""
...
class PublicOfflineRunRecord(StrictModel):
    ...
    temporal_context: TemporalContext
    pids_capability: DetectorCapabilitySnapshot
    detector: PIDSRef
