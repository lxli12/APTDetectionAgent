...
| REQ-LABEL-001 | Agent-visible processes cannot access hidden labels or private mappings | 1/3/7/9 | strict public schemas; separate evaluator namespace/process; Agent synthetic runner has no evaluator import | nested leakage and multi-process public-output tests; live permission tests deferred | partial |
