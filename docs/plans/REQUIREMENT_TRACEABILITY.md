...
| REQ-TOOL-005 | Timeout, nonzero exit, malformed output, and missing artifact fail closed | 2/5/8 | `pidsmaker/adapter.py`; `tooling/memory_tools.py`; `scripts/pidsmaker_stage_runner.py` | negative tests; preserved typed failures `structured-adapter-20260714-002/004/005`; real typed parser success `structured-adapter-20260714-007` | implemented |
