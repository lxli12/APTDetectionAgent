...
The project-owned adapter intentionally excludes synthetic attack generation.
"""
...
from pidsmaker_adapter.upstream.config import get_darpa_tc_node_feats_from_cfg, get_dates_from_cfg
from pidsmaker_adapter.upstream.utils.dataset_utils import get_rel2id
...
def gen_edge_fused_tw(indexid2msg, cfg):
    ...
    3. Builds NetworkX MultiDiGraphs with node attributes and edge metadata
    4. Saves graphs to disk organized by day and time window
    ...
    if mimicry_edge_num not in (None, 0):
        raise ValueError("Synthetic attack generation is excluded from pidsmaker_adapter")
