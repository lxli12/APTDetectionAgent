...
from pidsmaker_adapter.upstream.encoders import TGNEncoder
from pidsmaker_adapter.upstream.tgn import LastNeighborLoader
...
from pidsmaker_adapter.upstream.utils.utils import get_multi_datasets, log_dataset_stats, log_tqdm
        ...
        if method == "none":
            ...
            for data_list in dataset:
                ...
                for i in log_tqdm(
                    ...
                    use_tgn = "tgn" in cfg.training.encoder.used_methods
                    # The migrated production adapter does not carry upstream debug probes.
