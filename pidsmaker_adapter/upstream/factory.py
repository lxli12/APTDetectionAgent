...
from pidsmaker_adapter.upstream.config import decoder_matches_objective
from pidsmaker_adapter.upstream.decoders import *
from pidsmaker_adapter.upstream.encoders import *
from pidsmaker_adapter.upstream.losses import *
from pidsmaker_adapter.upstream.model import Model
from pidsmaker_adapter.upstream.objectives import *
from pidsmaker_adapter.upstream.tgn import IdentityMessage, LastAggregator, TGNMemory, TimeEncodingMemory
from pidsmaker_adapter.upstream.utils.data_utils import GraphReindexer
from pidsmaker_adapter.upstream.utils.dataset_utils import (
    get_node_map,
    get_num_edge_type,
    get_rel2id,
)
...
def build_model(data_sample, device, cfg, max_node_num):
    ...
    if cfg._is_running_mc_dropout:
        raise ValueError("MC dropout is outside the adapter's finite configuration space")
